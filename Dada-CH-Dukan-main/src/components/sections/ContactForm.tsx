      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-6 pl-6">
          ...
          <p className="text-gray-700 text-lg">
            “Let’s make a Smarter <br /> World together”
          </p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-10">
          ...
          <form className="grid grid-cols-2 gap-6">
            ...
            <div className="col-span-1">
              ...
              <input
                type="text"
                className="w-full mt-1 px-4 py-3 border border-gray-300 rounded-lg text-black text-sm focus:border-orange-500 focus:outline-none"
              />
            </div>
            ...
            <div className="col-span-2 pt-2">
              <label className="text-sm text-gray-700">
                Control For (you can select multiple)
              </label>
            ...
            <div className="col-span-1">
              ...
              <input
                type="text"
                className="w-full mt-1 px-4 py-3 border border-gray-300 rounded-lg text-black text-sm focus:border-orange-500"
              />
            </div>
            ...
            <div className="col-span-2">
              <input
                ...
                className="w-full mt-3 px-4 py-3 border border-gray-300 rounded-lg text-black text-sm focus:border-orange-500"
              />
            </div>

            {/* Submit */}
            <div className="col-span-2">
              <button className="mt-3 w-full py-3 bg-black text-white rounded-lg hover:bg-orange-600 transition">
                Submit
              </button>
            </div>
