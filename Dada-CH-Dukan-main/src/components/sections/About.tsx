...
//         {/* TOP STRIPE SECTION */}
//         <div className="bg-black rounded-2xl p-12 text-white flex flex-col lg:flex-row items-center gap-10 mb-24">
...
//   <div className="relative w-full h-72 rounded-xl overflow-hidden shadow-md bg-black">
//    <video
...
//   playsInline
// >
//   <source src="/vidhero/autovid.mp4" type="video/mp4" />
// </video>
